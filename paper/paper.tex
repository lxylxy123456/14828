...
Directory of the victim website:
...
.3 welcome.png.
.2 templates.
.3 \hyperref[victim-index.html]{index.html}.
.2 {victim.py}.
}

We are selectively showing some of the code for the context of this paper.

\subsection{victim/templates/index.html}
\label{victim-index.html}
